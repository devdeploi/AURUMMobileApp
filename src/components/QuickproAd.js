...
const adImages = [
    require('../../public/assests/Quickpro1.png'),
    require('../../public/assests/Quickpro2.png'),
    require('../../public/assests/Quickpro3.png'),
    require('../../public/assests/Quickpro4.png')
];
...
const QuickproAd = ({ visible, onClose, variant = 'full' }) => {
    ...
    // Use Effect for Full Screen Timer
    useEffect(() => {
        if (visible && variant === 'full') {
            setSecondsLeft(5);
            setCanClose(false);
            ...
            <View style={styles.bannerContainer}>
                <TouchableOpacity style={styles.bannerContent} onPress={handleAdPress} activeOpacity={0.9}>
                    ...
                    <View style={styles.bannerTextContainer}>
                        ...
                        <Text style={styles.bannerTitle}>Quickpro</Text>
                        <Text style={styles.bannerSubtitle}>Boost your business efficiency.</Text>
                    </View>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.footerContainer}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        />
                        <View>
                            <Text style={styles.adTitle}>Quickpro</Text>
                            <Text style={styles.adSubtitle}>Advanced Tools for Modern Businesses</Text>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    container: {
        flex: 1, // Full screen for Standard
        backgroundColor: '#000',
    },
    // Banner Styles (Premium)
    bannerContainer: {
        position: 'absolute',
        top: 50,
        left: 20,
    ...
    // Full Screen Styles (Copied & adapted from SchoolHubAd)
    headerContainer: {
        position: 'absolute',
        top: 0,
        left: 0,
