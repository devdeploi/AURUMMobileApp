                        ...
                        {buttons && buttons.length > 0 ? (
                            buttons.map((btn, index) => (
                                <TouchableOpacity
                                    ...
                                    style={[
                                        styles.button,
                                        { backgroundColor: btn.style === 'cancel' ? COLORS.secondary : COLORS.primary, flex: buttons.length > 1 ? 1 : 0, minWidth: '40%' }
                                    ]}
                                    onPress={() => {
                            ...
                            <TouchableOpacity
                                style={[styles.button, { backgroundColor: COLORS.primary, minWidth: '50%' }]}
                                onPress={onClose}
                            >
